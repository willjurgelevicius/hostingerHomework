...
describe('Hostinger Homework Spec', () => {
  it('passes', () => {
    ...
    cy.get('iframe[class="processout-field-cc-iframe"]').its('0.contentDocument').find('[name="cc-number"]').type(4000000000000002)
    ...
    cy.get('#errors', { timeout: 60000 }).should('have.text', 'The card 3DS check failed')
  })
})